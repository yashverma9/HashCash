...
brandWiseOther.to_json("src/brandWiseOther.json", orient = 'records')
...
brandWiseMonth.to_json("src/brandWiseMonth.json", orient = 'records')
...
topBrandMonth.to_json("src/topBrandMonth.json", orient = 'records')


fav_brands = ["iPlanet", "Adidas", "Gilly's", "H&M"]
favBrands = pd.DataFrame({"brand":fav_brands})
favBrands.to_json("src/favBrands.json", orient = 'records')
